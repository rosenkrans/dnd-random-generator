function newFullCharacter(){
    ...
    newHobby();
    newScent();
    newSiblingOneProfession();
    newSiblingTwoProfession();
    newSiblingThreeProfession();
    newSiblingFourProfession();
}
...
function newSiblingOneProfession(){
    var sibling_one_profession = Math.floor(Math.random() * sibling_one_professions.length);
    document.getElementById("siblingOneProfessionDisplay").innerHTML = sibling_one_professions[sibling_one_profession];
}

var sibling_two_professions = ["Priest or Priestess of Auril", "goddess of winter", "Priest or Priestess of Azuth", 
    "god of wizards", "Priest or Priestess of Bane", "god of tyranny", "Priest or Priestess of Beshaba", 
    "goddess of misfortune", "Priest or Priestess of Bhaal", "god of murder", 
    "Priest or Priestess of Chauntea", "goddess of agriculture", "Priest or Priestess of Deneir", 
    "god of writing", "Priest or Priestess of Eldath", "goddess of peace", "Priest or Priestess of Gond", 
...
function newSiblingTwoProfession(){
    var sibling_two_profession = Math.floor(Math.random() * sibling_two_professions.length);
    document.getElementById("siblingTwoProfessionDisplay").innerHTML = sibling_two_professions[sibling_two_profession];
}

var sibling_three_professions = ["Priest or Priestess of Auril", "goddess of winter", "Priest or Priestess of Azuth", 
    "god of wizards", "Priest or Priestess of Bane", "god of tyranny", "Priest or Priestess of Beshaba", 
    "goddess of misfortune", "Priest or Priestess of Bhaal", "god of murder", 
    "Priest or Priestess of Chauntea", "goddess of agriculture", "Priest or Priestess of Deneir", 
    "god of writing", "Priest or Priestess of Eldath", "goddess of peace", "Priest or Priestess of Gond", 
...
function newSiblingThreeProfession(){
    var sibling_three_profession = Math.floor(Math.random() * sibling_three_professions.length);
    document.getElementById("siblingThreeProfessionDisplay").innerHTML = sibling_three_professions[sibling_three_profession];
}

var sibling_four_professions = ["Priest or Priestess of Auril", "goddess of winter", "Priest or Priestess of Azuth", 
    "god of wizards", "Priest or Priestess of Bane", "god of tyranny", "Priest or Priestess of Beshaba", 
    "goddess of misfortune", "Priest or Priestess of Bhaal", "god of murder", 
    "Priest or Priestess of Chauntea", "goddess of agriculture", "Priest or Priestess of Deneir", 
    "god of writing", "Priest or Priestess of Eldath", "goddess of peace", "Priest or Priestess of Gond", 
...
function newSiblingFourProfession(){
    var sibling_four_profession = Math.floor(Math.random() * sibling_four_professions.length);
