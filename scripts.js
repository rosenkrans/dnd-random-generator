function newFullCharacter(){
    newAttribute('raceDisplay', races);
    newAttribute('hairColorDisplay', hair_colors);
    newAttribute('tattooDisplay', tattoos)
    newAttribute('archetypeDisplay', archetypes)
    newAttribute('newFavoriteFood', foods)
    newAttribute('randomEncounterDisplay', random_encounters)
    newAttribute('placeOfBirthDisplay', places_of_birth)
    newAttribute('caretakerOneRaceDisplay', races)
    newAttribute('caretakerOneArchetypeOneDisplay', archetypes)
    newAttribute('caretakerTwoRaceDisplay', races)
    newAttribute('caretakerTwoArchetypeTwoDisplay', archetypes)
    newAttribute('numberOfSiblingsDisplay', numbers_of_siblings)
    newAttribute('siblingOneDisplay', siblings)
    newAttribute('siblingOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('siblingTwoDisplay', siblings)
    newAttribute('siblingTwoRoleInSocietyDisplay', roles_in_society)
    newAttribute('siblingThreeDisplay', siblings)
    newAttribute('siblingThreeRoleInSocietyDisplay', roles_in_society)
    newAttribute('siblingFourDisplay', siblings)
    newAttribute('siblingFourRoleInSocietyDisplay', roles_in_society)
    newAttribute('relationshipOneDisplay', relationships)
    newAttribute('relationshipArchetypeOneDisplay', archetypes)
    newAttribute('appearanceTraitOneDisplay', appearance_traits)
    newAttribute('relationshipTwoDisplay', relationships)
    newAttribute('relationshipArchetypeTwoDisplay', archetypes)
    newAttribute('appearanceTraitTwoDisplay', appearance_traits)
    newAttribute('relationshipThreeDisplay', relationships)
    newAttribute('relationshipArchetypeThreeDisplay', archetypes)
    newAttribute('appearanceTraitThreeDisplay', appearance_traits)
    newAttribute('madeAnEnemyOneDisplay', enemies)
    newAttribute('enemyArchetypeOneDisplay', archetypes)
    newAttribute('madeAnEnemyTwoDisplay', enemies)
    newAttribute('enemyArchetypeTwoDisplay', archetypes)
    newAttribute('madeAnEnemyThreeDisplay', enemies)
    newAttribute('enemyArchetypeThreeDisplay', archetypes)
    newAttribute('madeAFriendOneDisplay', friends)
    newAttribute('friendArchetypeOneDisplay', archetypes)
    newAttribute('madeAFriendTwoDisplay', friends)
    newAttribute('friendArchetypeTwoDisplay', archetypes)
    newAttribute('madeAFriendThreeDisplay', friends)
    newAttribute('friendArchetypeThreeDisplay', archetypes)
    newAttribute('skinColorDisplay', skin_colors)
    newAttribute('hairStyleDisplay', hair_styles)
    newAttribute('scentDisplay', scents)
    newAttribute('characterFlawDisplay', character_flaws)
    newAttribute('favoriteWineDisplay', wine_liquors)
    newAttribute('woundDisplay', wounds)
    newAttribute('caretakerDisplay', caretakers)
    newAttribute('caretakerOneProfessionDisplay', professions)
    newAttribute('caretakerOneRelationshipDisplay', relationships)
    newAttribute('caretakerTwoProfessionDisplay', professions)
    newAttribute('caretakerTwoRelationshipDisplay', relationships)
    newAttribute('numberOfRomancesDisplay', number_of_romances)
    newAttribute('siblingOneProfessionDisplay', professions)
    newAttribute('siblingOneRelationshipDisplay', relationships)
    newAttribute('siblingTwoProfessionDisplay', professions)
    newAttribute('siblingTwoRelationshipDisplay', relationships)
    newAttribute('siblingThreeProfessionDisplay', professions)
    newAttribute('siblingThreeRelationshipDisplay', relationships)
    newAttribute('siblingFourProfessionDisplay', professions)
    newAttribute('siblingFourRelationshipDisplay', relationships)
    newAttribute('relationshipOneProfessionDisplay', professions)
    newAttribute('relationshipOneRaceDisplay', races)
    newAttribute('relationshipOneGenderDisplay', genders)
    newAttribute('relationshipTwoProfessionDisplay', professions)
    newAttribute('relationshipTwoRaceDisplay', races)
    newAttribute('relationshipTwoGenderDisplay', genders)
    newAttribute('relationshipThreeProfessionDisplay', professions)
    newAttribute('relationshipThreeRaceDisplay', races)
    newAttribute('relationshipThreeGenderDisplay', genders)
    newAttribute('enemyOneBecauseDisplay', enemy_becauses)
    newAttribute('enemyOneProfessionDisplay', professions)
    newAttribute('enemyTwoBecauseDisplay', enemy_becauses)
    newAttribute('enemyTwoProfessionDisplay', professions)
    newAttribute('enemyThreeBecauseDisplay', enemy_becauses)
    newAttribute('enemyThreeProfessionDisplay', professions)
    newAttribute('friendOneBecauseDisplay', friend_becauses)
    newAttribute('friendOneProfessionDisplay', professions)
    newAttribute('friendTwoBecauseDisplay', friend_becauses)
    newAttribute('friendTwoProfessionDisplay', professions)
    newAttribute('friendThreeBecauseDisplay', friend_becauses)
    newAttribute('friendThreeProfessionDisplay', professions)
    newAttribute('appearanceTraitDisplay', appearance_traits)
    newAttribute('miscTreasureItemDisplay', treasures)
    newAttribute('phobiaDisplay', phobias)
    newAttribute('roleInSocietyDisplay', roles_in_society)
    newAttribute('fateDisplay', fates)
    newAttribute('childhoodDisplay', childhoods)
    newAttribute('caretakerOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('caretakerOneFateDisplay', fates)
    newAttribute('caretakerTwoRoleInSocietyDisplay', roles_in_society)
    newAttribute('caretakerTwoFateDisplay', fates)
    newAttribute('numberOfChildrensDisplay', numbers_of_children)
    newAttribute('siblingOneArchetypeDisplay', archetypes)
    newAttribute('siblingOneFateDisplay', fates)
    newAttribute('siblingTwoArchetypeDisplay', archetypes)
    newAttribute('siblingTwoFateDisplay', fates)
    newAttribute('siblingThreeArchetypeDisplay', archetypes)
    newAttribute('siblingThreeFateDisplay', fates)
    newAttribute('siblingFourArchetypeDisplay', archetypes)
    newAttribute('siblingFourFateDisplay', fates)
    newAttribute('relationshipOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('relationshipOneGoalDesireSecretDisplay', goals_desires_secrets)
    newAttribute('relationshipOneScentDisplay', scents)
    newAttribute('relationshipTwoRoleInSocietyDisplay', roles_in_society)
    newAttribute('relationshipTwoGoalDesireSecretDisplay', goals_desires_secrets)
    newAttribute('relationshipTwoScentDisplay', scents)
    newAttribute('relationshipOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('relationshipThreeGoalDesireSecretDisplay', goals_desires_secrets)
    newAttribute('relationshipThreeScentDisplay', scents)
    newAttribute('enemyOneStrengthOfEnmityDisplay', strengths_of_enmity)
    newAttribute('enemyOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('enemyTwoStrengthOfEnmityDisplay', strengths_of_enmity)
    newAttribute('enemyTwoRoleInSocietyDisplay', roles_in_society)
    newAttribute('enemyThreeStrengthOfEnmityDisplay', strengths_of_enmity)
    newAttribute('enemyThreeRoleInSocietyDisplay', roles_in_society)
    newAttribute('strengthOfFriendshipOneDisplay', strengths_of_friendship)
    newAttribute('friendOneRoleInSocietyDisplay', roles_in_society)
    newAttribute('strengthOfFriendshipTwoDisplay', strengths_of_friendship)
    newAttribute('friendTwoRoleInSocietyDisplay', roles_in_society)
    newAttribute('strengthOfFriendshipThreeDisplay', strengths_of_friendship)
    newAttribute('friendThreeRoleInSocietyDisplay', roles_in_society)
}
...
var foods = ['Slop', 'Sausages', 'Goat Leg', 'Green Eggs and Ham', 'Acorn soup', 'Frogs on skewers', 'Lizard gruel with grilled snake', 
...
var relationships = ['Casual, and is continuing',  'Casual, but has just ended by mutual agreement',
     'Casual, but has just ended with anger and violent enmity',  
     'Casual, with unintended pregnancy leading to forced marriage', 
     'Casual, with unintended pregnancy that has just resulted in a break up',  
     'Casual, has just ended because they cheated on you and you found out', 
     'Casual, has just ended because you cheated on them and they found out', 
     'Casual, has just ended because of their misfortune', 
     'Casual, has just ended because of their death', 'Serious, and is continuing', 
     'Serious, but has just ended by mutual agreement', 
     'Serious, but has just ended with anger and violent enmity', 
     'Serious, with unintended pregnancy leading to forced marriage', 
     'Serious, with unintended pregnancy that has just resulted in a break up', 
     'Serious, has just ended because they cheated on you and you found out', 
     'Serious, has just ended because you cheated on them and they found out', 
     'Serious, has just ended because of their misfortune', 
     'Serious, has just ended because of their death', 'A Good Thing, and is continuing', 
     'A Good Thing, and is continuing, with intentions to marry', 
     'A Good Thing, but has just ended by mutual agreement', 
     'A Good Thing, but has just ended with anger and violent enmity', 
     'A Good Thing, with unintended pregnancy leading to willing marriage', 
     'A Good Thing, with unintended pregnancy leading to forced marriage', 
     'A Good Thing, with unintended pregnancy that has just resulted in a break up', 
     'A Good Thing, has just ended because they cheated on you and you found out', 
     'A Good Thing, has just ended because you cheated on them and they found out', 
     'A Good Thing, has just ended because of their misfortune', 
     'A Good Thing, has just ended because of their death', 'A Terrible Thing, and is continuing', 
      'A Terrible Thing, and is continuing, with intentions to marry', 
      'A Terrible Thing, but has just ended by mutual agreement', 
      'A Terrible Thing, but has just ended with anger and violent enmity', 
      'A Terrible Thing, with unintended pregnancy leading to willing marriage', 
      'A Terrible Thing, with unintended pregnancy leading to forced marriage', 
      'A Terrible Thing, with unintended pregnancy that has just resulted in a break up', 
      'A Terrible Thing, has just ended because they cheated on you and you found out', 
      'A Terrible Thing, has just ended because you cheated on them and they found out', 
      'A Terrible Thing, has just ended because of their misfortune', 
      'A Terrible Thing, has just ended because of their death', 
      'Arranged Betrothal, and is continuing', 
      'Arranged Betrothal, and is continuing, with intentions to marry', 
      'Arranged Betrothal, but has just ended by mutual agreement', 
      'Arranged Betrothal, but has just ended with anger and violent enmity', 
      'Arranged Betrothal, with unintended pregnancy leading to willing marriage', 
      'Arranged Betrothal, with unintended pregnancy leading to forced marriage', 
      'Arranged Betrothal, with unintended pregnancy that has just resulted in a break up', 
      'Arranged Betrothal, has just ended because they cheated on you and you found out', 
      'Arranged Betrothal, has just ended because you cheated on them and they found out', 
      'Arranged Betrothal, has just ended because of their misfortune', 
      'Arranged Betrothal, has just ended because of their death', 'Married, and is continuing',  
      'Married, but has just ended by mutual agreement', 
      'Married, but has just ended with anger and violent enmity', 
      'Married, has just ended because they cheated on you and you found out', 
      'Married, has just ended because you cheated on them and they found out', 
      'Married, has just ended because of their misfortune', 
      'Married, has just ended because of their death',]

var friends = ['A childhood enemy', 'An ex-lover', 'An estranged relative', 'A boss', 
    'An employee', 'A partner', 'A Legal Authority', 'A Religious Authority', 'A Criminal contact',
     'A Dark Power', 'A Light Power', 'A Teacher', 'A Mentor', 'A Surrogate Parent', 'Coworker']

var enemies = ['A childhood friend', 'A lover', 'A relative', 'A boss', 'An employee', 
    'A partner', 'A Legal Authority', 'A Religious Authority', 'A Criminal contact', 
    'A Dark Power', 'A Light Power', 'A Teacher', 'A Mentor', 'A Surrogate Parent', 
    'Coworker', 'Like a kid brother', 'Like a kid sister', 'A Member of your Clan/Tribe/Gang']
...
var enemy_becauses = ['because you humiliated them', 'because they humiliated you', 
    'because you busted them', 'because they busted you', 'because you defeated them', 
    'because they defeated you', 'because you are a bigot to them', 'because they are a bigot to you', 
    'because you betrayed them', 'because they betrayed you', 'because you are jealous of them', 
    'because they are jealous of you', 'because you took advantage of them', 
    'because they took advantage of you', 'because you betrayed their family member', 
    'because they betrayed your family member', 'because you murdered their family member', 
    'because they murdered your family member', 'because you lied to them', 'because they lied to you']

var friend_becauses = ['because you helped them', 'because they helped you', 
    'because you saved their life', 'because they saved your life', 
    'because you defeated their enemy', 'because they defeated your enemy', 
    'because you taught then something valuable', 'because they taught you something valuable', 
    'because you were in an accident together', 'because you escaped trouble together', 
    'because you have the same enemy', 'because you have the same friend', 
    'because you share a hobby', 'because they gave you something valuable', 
    'because you gave them something valuable', 'because you both lost the same person', 
    'because you worked together', 'because you were partners', 
...
'Unwilling necromancer', 'Uncontrolled pyromancer', 'Warfare as a participant',  'Warfare as collateral damage', 
...
var goals_desires_secrets = ['Missing relative', 'Unrequited romance', 'Missing lover', 
...
var genders = ['Androgynous', 'Cis Male', 'Cis Female', 'Trans Male', 'Trans Female', 'Gender fluid']

var treasures = ['Gold', 'Silver', 'Donkey Dung']

var strengths_of_enmity = ['Bothered', 'Shunning', 'Coldly angry', 'Violently angry', 'Cold Murder',
     'Hot Murder', 'Utter Ruination']

var strengths_of_friendship = ['Casual', 'Fast friends', 'Confidants', 'They owe  you a favor or debt', 
    'You owe them a favor or debt', 'Daily companions', 'Soon to be lovers']

var numbers_of_children = ['0', '1', '2']
